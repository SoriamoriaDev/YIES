...
app.get('/new_evaluation_2', new_evaluationController.getNewEvaluation2);
app.post('/new_evaluation_2', new_evaluationController.postNewEvaluation2);
app.get('/new_evaluation_3', new_evaluationController.getNewEvaluation3);
app.post('/new_evaluation_3', new_evaluationController.postNewEvaluation3);
app.get('/new_evaluation_4', new_evaluationController.getNewEvaluation4);
app.post('/new_evaluation_4', new_evaluationController.postNewEvaluation4);
app.get('/survey', surveyController.getSurvey);
app.post('/survey', surveyController.postSurvey);
...
app.get('/signup2', userController.getSignup2);
...
var j = schedule.scheduleJob({hour: 12, minute: 17}, function(){
  sendEmail();
